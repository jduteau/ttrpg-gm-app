# OSE Advanced Fantasy — Session State Template
...
# The Lolth Conspiracy — Session State
...
- **Pending checks**: [any rolls called for but not yet made — e.g. "Thomas save vs. Poison outstanding", or "None"]
...
- Thief Skills: Climb [x]% | Traps [x]% | Hear [x–x/d6] | Hide [x]% | Move Silent [x]% | Locks [x]% | Pick Pockets [x]%
...
- Lay on Hands: [x HP available today] | Turn Undead: [not yet / as Cleric level x]

**Brother Aldric** — Cleric [level], Lawful Good *(GM voiced)*
